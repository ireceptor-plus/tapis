...
# upload app assets
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM olga.sh
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM olga.json
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM ../common/olga_common.sh
tapis files list agave:///irplus/apps/$TOOL/$VER/$SYSTEM

# upload test assets
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM/test test/test.sh
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM/test ../common/test/example_seqs_CDR3_TRB.tsv
