...
# upload app assets
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM cellranger.sh
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM cellranger.json
tapis files upload agave:///irplus/apps/$TOOL/$VER/$SYSTEM ../common/cellranger_common.sh
